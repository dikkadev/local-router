...
@media (max-width:760px){body{margin:.75rem;font-size:14px;line-height:1.3}h1{font-size:1.3rem}.muted{font-size:.85rem;margin:.35rem 0}.notice{min-height:1em}table,thead,tbody,tr,td{display:block}table{border-collapse:separate}thead{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap}tbody{display:grid;gap:.45rem}tbody tr{display:grid;grid-template-columns:minmax(0,1fr) auto;grid-template-areas:'name status' 'title title' 'url url' 'target actions';gap:.18rem .55rem;border:1px solid #303030;border-radius:.55rem;padding:.5rem .55rem;background:#101010}tbody tr.pinned{background:rgba(244,199,80,.08);box-shadow:inset 3px 0 0 #d8b84b}tbody tr.missed{background:rgba(255,109,64,.1);box-shadow:inset 3px 0 0 #f06d3d}td{border:0;padding:0;min-width:0}td::before{content:none!important}td:nth-child(1){grid-area:name;font-size:1rem;line-height:1.2}td:nth-child(2){grid-area:url;font-size:.85rem}td:nth-child(2) a{overflow-wrap:anywhere}td:nth-child(3){grid-area:title;color:#cfcfcf;font-size:.88rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}td:nth-child(4){grid-area:status;justify-self:end}td:nth-child(5),td:nth-child(6),td:nth-child(8),td:nth-child(9),td:nth-child(10){display:none}td:nth-child(7){grid-area:target;color:#aaa;font-size:.78rem}td:nth-child(11){grid-area:actions}.status-badge{font-size:.75em;padding:.02rem .35rem}.route-actions{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:.25rem;white-space:normal}.route-actions button{margin:0;font-size:.72rem;padding:.22rem .32rem}.icon-button{width:2rem;height:2rem}.form-grid{grid-template-columns:1fr}}
</style>
</head>
<body>
